...
<html>
   ...
   while(examid.next())
   {
    ...
    session1.setAttribute("marks", examid.getInt(5));
    session1.setAttribute("total_marks",examid.getInt(6));
   %>
   <script>
   function showTimer(){
   var time;
   ...
   <form method="post" action=../marks>
    ...
    <div>
    <br><hr class="line"> 
    <label class="w3-green w3-padding" style="display: block; font-family: arial black;font-size: 18px;"><%=i%>]&nbsp;<%=rs.getString(2)%></label>
     ...
     <br><input type="radio" id="opt5<%=i%>" name="rd<%=i%>" value="786"  checked>
      <% String ans ="ans"+i;%>
